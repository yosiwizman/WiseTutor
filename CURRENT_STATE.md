...
- Full human-audible mic→LLM→speakers end-to-end conversation: **Tier 3** — requires a human to run one real PTT cycle in Chrome at the ai-desktop display and confirm the Piper speech was audible and matched the LLM reply.
